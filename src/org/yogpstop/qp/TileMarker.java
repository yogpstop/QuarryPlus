...
public class TileMarker extends TileBuildCraft implements IAreaProvider {
	...
	public void tryConnection() {
		if (CoreProxy.proxy.isRenderWorld(this.worldObj)) return;
	...
	private boolean linkTo(TileMarker marker, int n) {
		...
		if (this.origin.isSet() && marker.origin.isSet()) return false;
	...
	@Override
	public int xMin() {
		if (this.origin.isSet()) return this.origin.xMin;
		return this.xCoord;
	}

	@Override
	public int yMin() {
		if (this.origin.isSet()) return this.origin.yMin;
		return this.yCoord;
	}

	@Override
	public int zMin() {
		if (this.origin.isSet()) return this.origin.zMin;
		return this.zCoord;
	}

	@Override
	public int xMax() {
		if (this.origin.isSet()) return this.origin.xMax;
		return this.xCoord;
	}

	@Override
	public int yMax() {
		if (this.origin.isSet()) return this.origin.yMax;
		return this.yCoord;
	}

	@Override
	public int zMax() {
		if (this.origin.isSet()) return this.origin.zMax;
		return this.zCoord;
	}

...
public class GuiQuarryList extends GuiScreen {
    ...
    @Override
    public void initGui() {
        this.buttonList.add(new GuiButton(TileQuarry.openQuarryGui, this.width / 2 - 125, this.height - 26, 250, 20, StatCollector.translateToLocal("gui.done")));
        ...
        this.oreslot = new GuiSlotQuarryList(this.mc, this.width * 3 / 5, this.height, 30, this.height - 30, 18, this, this.targetid == 1 ? this.quarry.fortuneList
                : this.quarry.silktouchList);
    }

    public boolean include() {
        if (this.targetid == 1)
            return this.quarry.fortuneInclude;

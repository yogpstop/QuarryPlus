...
public class GuiQuarry extends GuiContainer {
    ...
    public void setNames() {
        ...
        this.a4.displayString = translateToLocal("gui.removeWater").concat(" : ").concat(translateToLocal("options.".concat(this.tileQuarry.removeWater ? "on" : "off")));
        this.a5.displayString = translateToLocal("gui.removeLava").concat(" : ").concat(translateToLocal("options.".concat(this.tileQuarry.removeLava ? "on" : "off")));

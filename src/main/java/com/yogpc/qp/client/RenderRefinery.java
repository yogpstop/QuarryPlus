...
public class RenderRefinery extends TileEntitySpecialRenderer implements
  ...
  private static final ResourceLocation TEXTURE = new ResourceLocation("yogpstop_qp",
  ...
  public void renderInventoryBlock(final Block block, final int metadata, final int modelID,
    ...
    if (block.getRenderType() != getRenderId())
      return;
  ...
  @Override
  public boolean shouldRender3DInInventory(final int arg0) {
    return true;
  }

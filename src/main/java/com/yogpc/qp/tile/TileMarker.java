...
public class TileMarker extends APacketTile implements IAreaProvider {
  public static final ArrayList<Link> linkList = new ArrayList<Link>();
  public static final ArrayList<Laser> laserList = new ArrayList<Laser>();
  ...
  public void removeFromWorld() {
    if (this.link == null) {
      QuarryPlusI.blockMarker.dropBlockAsItem(this.worldObj, this.xCoord, this.yCoord, this.zCoord,
  ...
  public Collection<ItemStack> removeFromWorldWithItem() {
    ...
    ret.addAll(QuarryPlusI.blockMarker.getDrops(this.worldObj, this.xCoord, this.yCoord,
        this.zCoord, 0, 0));
    this.worldObj.setBlockToAir(this.xCoord, this.yCoord, this.zCoord);
    return ret;
  }
  ...
  @Override
  public void S_recievePacket(final byte id, final byte[] data, final EntityPlayer ep) {// onPacketData
    switch (id) {
  ...
  @Override
  public void C_recievePacket(final byte id, final byte[] data, final EntityPlayer ep) {// onPacketData
  ...
  public void invalidate() {
    super.invalidate();
    if (this.worldObj.getBlock(this.xCoord, this.yCoord, this.zCoord) != QuarryPlusI.blockMarker)
      G_destroy();
  }
}

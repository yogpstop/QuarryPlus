...
public class PowerManager {
  ...
  static void loadConfiguration(final Configuration cg) throws RuntimeException {
    final String cn =
        new StringBuilder().append(Configuration.CATEGORY_GENERAL)
            .append(Configuration.CATEGORY_SPLITTER).append("PowerSetting")
            .append(Configuration.CATEGORY_SPLITTER).toString();

    String cn2 =
        new StringBuilder().append(cn).append("Quarry").append(Configuration.CATEGORY_SPLITTER)
            .toString();
    ConfigCategory c =
    ...
    c =
        cg.getCategory(new StringBuilder().append(cn2).append("BreakBlock")
            .append(Configuration.CATEGORY_SPLITTER).append("MoveHead").toString());
    ...
    cn2 =
        new StringBuilder().append(cn).append("Pump").append(Configuration.CATEGORY_SPLITTER)
            .toString();
